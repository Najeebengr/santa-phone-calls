...
function SuccessContent() {
  ...
  useEffect(() => {
    ...
    if (paymentIntent && redirectStatus === "succeeded") {
      trackPurchase(paymentIntent, parseFloat(amount), packageName, {
    ...
    >
      ...
      <div className="space-y-6 mb-8">
        ...
        <div className="p-4 rounded-xl bg-white/5">
          <p className="font-harmonia text-white/80 text-center">
            Check your email for your booking confirmation and instructions for
            your upcoming call with Santa!
          </p>
        </div>
      </div>
      ...
      <div className="mt-8 text-center">
        <p className="font-harmonia text-white/80 text-md">
          ...
          <a
            href="mailto:support@santaphonecalls.com"
            className="text-[#D7C798] hover:underline"
          >

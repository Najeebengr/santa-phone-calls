    ...
    <div className="relative w-full">
      {!isExpanded ? (
        ...
        >
          <div className="flex flex-row items-center gap-3 w-[174px] h-[30px]">
            <div 
              ...
              style={{
                background: 'linear-gradient(93.5deg, #D7C798 22.11%, #EDE4CC 54.95%, #D7C798 79.77%)',
            ...
            <span 
              className="w-[132px] h-[24px] font-seasons font-bold text-[20px] leading-[24px] text-center text-white"
            >
              Listen to a Call
            </span>
          </div>
        ...
        >
          ...
          <span className="text-[#D7C798] font-seasons text-[20px] leading-[24px] font-bold absolute left-1/2 -translate-x-1/2">
